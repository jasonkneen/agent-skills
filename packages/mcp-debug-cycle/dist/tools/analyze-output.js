...
export const analyzeOutputTool = {
    name: "debug_analyze_output",
    description: "Analyze captured debug output to identify patterns, errors, and insights. Can analyze latest capture or a specific file.",
    inputSchema: {
        type: "object",
        properties: {
            capture_file: {
                type: "string",
                description: "Path to capture file (default: latest in ~/.claude/debug-captures/)",
            },
            focus: {
                type: "string",
 ...
 */
function extractDebugLogs(content) {
    return content
        .split("\n")
 ...
 */
function analyzeFlow(debugLogs) {
...
export async function analyzeOutput(args) {
...
//# sourceMappingURL=analyze-output.js.map