...
export const removeLogsTool = {
    name: "debug_remove_logs",
    description: "Remove all debug logging statements (marked with AUTO-DEBUG comment) from a file",
    inputSchema: {
        type: "object",
        properties: {
            file_path: {
...
export async function removeLogs(args) {
...
//# sourceMappingURL=remove-logs.js.map