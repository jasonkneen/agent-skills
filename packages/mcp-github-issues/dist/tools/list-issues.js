...
export const listIssuesTool = {
    ...
    description: "List GitHub issues with optional filters for state, labels, assignee, and author",
    inputSchema: {
        type: "object",
        properties: {
            owner: {
...
export async function listIssues(args) {
    const { owner, repo, state = "open", labels, assignee, author, limit = 30, } = args;
    const ghArgs = [
        "issue",
        "list",
        "-R",
