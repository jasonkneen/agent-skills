...
describe("gh-cli", () => {
    ...
    describe("gh()", () => {
        ...
        it("should allow valid issue commands", async () => {
            ...
            spy.mockImplementation(((_file, _args, _opts, callback) => {
                if (callback) {
                    callback(null, { stdout: '{"number": 123}', stderr: '' }, null);
                }
                return {};
            }));
        ...
        it("should handle JSON parse errors gracefully", async () => {
            ...
            spy.mockImplementation(((_file, _args, _opts, callback) => {
                if (callback) {
                    callback(null, { stdout: 'not json', stderr: '' }, null);
                }
                return {};
            }));
        ...
        it("should handle stderr without stdout", async () => {
            ...
            spy.mockImplementation(((_file, _args, _opts, callback) => {
                if (callback) {
                    callback(null, { stdout: '', stderr: 'Issue not found' }, null);
                }
                return {};
            }));
